                    ...
                    <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                        ...
                        <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                ...
                                <input type="text" name="shortDesc" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Short Desc">
                            </div>

                            <div class="mt-4">
                                <label class="block text-sm font-bold text-gray-700" for="title">Desc</label>
                                <textarea name="description" rows="4" cols="" class="tinymce-editor block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Desc"></textarea>
                            </div>
