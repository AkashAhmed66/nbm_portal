<x-app-layout>
    <div class="max-w-6xl mx-auto mt-8">
        ...
        <div class="flex justify-end mt-10">
            <a href="{{ route('services.create') }}" class="px-2 py-1 rounded-md bg-blue-500 text-sky-100 hover:bg-blue-700">+ Create New</a>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <form action="{{ route('services.destroy',$item->id) }}" method="POST">
                                        ...
                                        <a href="{{ route('services.edit',$item->id) }}" class="text-indigo-600 hover:text-indigo-900 text-gray-600">
