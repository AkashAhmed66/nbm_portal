    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('service-types.index') }}" :active="request()->routeIs('service-types.index')">
                        {{ __('Service Types') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('service-categories.index') }}" :active="request()->routeIs('service-categories')">
                        {{ __('Service Category') }}
                    </x-jet-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('certificate.index') }}" :active="request()->routeIs('certificate')">
                        {{ __('Certificate') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('report-categories.index') }}" :active="request()->routeIs('report-categories')">
                        {{ __('Report Category') }}
                    </x-jet-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('news.index') }}" :active="request()->routeIs('news')">
                        {{ __('News') }}
                    </x-jet-nav-link>
                </div>
