    ...
    <div class="max-w-6xl mx-auto mt-8">
        <div class="mb-4">
            ...
            <div class="flex justify-end mt-5">
                <a href="{{ route('certificate.create') }}" class="px-2 py-1 rounded-md bg-blue-500 text-sky-100 hover:bg-blue-700">+ Create New</a>
            </div>
        </div>
                ...
                <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                    ...
                    <table class="min-w-full">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Number</th>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $item->type }}</td>
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $item->number }}</td>
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <form action="{{ route('certificate.destroy',$item->id) }}" method="POST" class="inline-block">

                                        <a href="{{ route('certificate.edit', $item->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                        ...
                                        <button type="submit" onclick="return confirm('Are you sure you want to delete this certificate?')">
