    ...
    <div class="max-w-6xl mx-auto mt-8">
        <div class="mb-4">
            ...
            <div class="flex justify-end mt-5">
                <a href="{{ route('report-categories.create') }}" class="px-2 py-1 rounded-md bg-blue-500 text-sky-100 hover:bg-blue-700">+ Create New</a>
            </div>
        </div>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <form action="{{ route('report-categories.destroy',$item->id) }}" method="POST">

                                        <a href="{{ route('report-categories.edit',$item->id) }}" class="text-indigo-600 hover:text-indigo-900 text-gray-600">
